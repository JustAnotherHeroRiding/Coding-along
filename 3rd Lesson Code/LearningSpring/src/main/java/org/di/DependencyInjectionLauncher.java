...
class YourBusinessClass {
    ...
    //@Autowired Autowired is not needed when using the constructor
...
public class DependencyInjectionLauncher {
    ...
    public static void main(String[] args) {
        try (
            ...
            BusinessCalculationService bcs = context.getBean(BusinessCalculationService.class);
